...
using MachineVision.App.ViewModels;
using MachineVision.App.ViewModels.Base;
using MachineVision.App.Views;
//using Xamarin.Forms;

namespace MachineVision.App.Services.Navigation
{
    public partial class NavigationService : INavigationService
    {
        ...
        void CreatePageViewModelMappings()
        {
            ...
            mappings.Add(typeof(FeatureMatchViewModel), typeof(FeatureMatchView));
